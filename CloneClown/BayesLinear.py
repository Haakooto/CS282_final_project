...
class Linear(nn.Module):
    def __init__(self, *, inn, out, loc=0, scale=1, dist="normal", dist_kwargs={}, device=None, dtype=None, use_bias=True, record=False):
        ...
        # self.weight_loc.data = self.prior.loc
        # self.weight_rho.data = torch.log(torch.exp(self.prior.scale) - 1)
        # self.weight_rho.data = self.prior.scale

        # print(self.weight_loc.size())
        # self.weight_loc.data = self.prior.sample()
        # self.weight_rho.data = self.prior.sample()
        # print(self.weight_loc.size())
    ...
    def forward(self, x):
        ...
        # print(weight_scale.mean())
        # print(weight_scale.std())
        # print(self.weight_loc.mean())
        # print(self.weight_loc.std())
        # print()
